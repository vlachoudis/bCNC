...
!(function(a, b) {
  ...
  (n.fn = n.prototype = {
    ...
    n.extend({
      ...
      trim: function(a) {
        return a == null ? "" : String(a).replace(o, "");
      },
      makeArray: function(a, b) {
        var c = b || [];
        return (
          a != null &&
            (s(Object(a)) ? n.merge(c, typeof a === "string" ? [a] : a) : f.call(c, a)),
          c
        );
      },
      ...
      merge: function(a, b) {
        for (var c = Number(b.length), d = 0, e = a.length; c > d; d++) a[e++] = b[d];
        return (a.length = e), a;
      },
      grep: function(a, b, c) {
      ...
      (d = ga.selectors = {
          ...
          CHILD: function(a) {
            return (
              ...
              a[1].slice(0, 3) === "nth"
                ? (a[3] || ga.error(a[0]),
                  (a[4] = Number(
                    a[4] ? a[5] + (a[6] || 1) : 2 * (a[3] === "even" || a[3] === "odd")
                  )),
                  (a[5] = Number(a[7] + a[8] || a[3] === "odd")))
                : a[3] && ga.error(a[0]),
              a
            );
          },
        ...
        pseudos: {
          ...
          checked: function(a) {
            ...
            return (
              (b === "input" && Boolean(a.checked)) ||
              (b === "option" && Boolean(a.selected))
            );
          },
          selected: function(a) {
  ...
  (n.filter = function(a, b, c) {
    ...
    n.fn.extend({
      ...
      is: function(a) {
        return Boolean(
          x(this, typeof a === "string" && u.test(a) ? n(a) : a || [], !1).length
        );
      },
    });
  var y,
      ...
      queue: function(a, b, c) {
        ...
        return a
          ? ((b = (b || "fx") + "queue"),
            (d = L.get(a, b)),
            c &&
              (!d || n.isArray(c) ? (d = L.access(a, b, n.makeArray(c))) : d.push(c)),
            d || [])
          : void 0;
      },
  ...
  var Q = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    S = function(a, b) {
      return (
        (a = b || a), n.css(a, "display") === "none" || !n.contains(a.ownerDocument, a)
      );
    },
    T = /^(?:checkbox|radio)$/i;
  !(function() {
  ...
  (n.event = {
    ...
    keyHooks: {
      ...
      filter: function(a, b) {
        return (
          a.which == null && (a.which = b.charCode != null ? b.charCode : b.keyCode), a
        );
      },
    },
    mouseHooks: {
    ...
    special: {
      ...
      click: {
        trigger: function() {
          return this.type === "checkbox" && this.click && n.nodeName(this, "input")
            ? (this.click(), !1)
            : void 0;
        },
        _default: function(a) {
  ...
  n.extend({
    clone: function(a, b, c) {
      ...
      if (
        !(k.noCloneChecked || (a.nodeType !== 1 && a.nodeType !== 11) || n.isXMLDoc(a))
      )
    ...
    n.fn.extend({
      ...
      remove: function(a, b) {
        for (var c, d = a ? n.filter(a, this) : this, e = 0; (c = d[e]) != null; e++)
          b || c.nodeType !== 1 || n.cleanData(oa(c)),
            c.parentNode &&
          ...
          function(a) {
            ...
            if (
              ...
              try {
                for (; d > c; c++)
                  (b = this[c] || {}),
                    b.nodeType === 1 && (n.cleanData(oa(b, !1)), (b.innerHTML = a));
                b = 0;
              } catch (e) {}
            }
  ...
  function Ia(a, b, c) {
    ...
    if (e <= 0 || e == null) {
      if (((e = xa(a, b, f)), (e < 0 || e == null) && (e = a.style[b]), va.test(e)))
        return e;
      ...
      for (d in m)
        (g = Ua(p ? q[d] : 0, d, l)),
          d in q ||
            ((q[d] = g.start),
            p &&
              ((g.end = g.start), (g.start = d === "width" || d === "height" ? 1 : 0)));
    }
  }
  function Wa(a, b) {
    var c, d, e, f, g;
        ...
        if (e)
          return (
            ...
            b && "get" in b && void 0 !== (c = b.get(e, "value"))
              ? c
              : ((c = e.value),
                typeof c === "string" ? c.replace(bb, "") : c == null ? "" : c)
          );
      }
    },
  }),
  ...
  a.attachEvent &&
    ...
    (k.cors = Boolean(Eb) && "withCredentials" in Eb),
    (k.ajax = Eb = Boolean(Eb)),
